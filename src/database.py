...
def save_duty_analysis(analysis_data, week_ending_date, created_by_user_id=None):
    ...
    try:
        ...
        save_data = {
            'week_ending_date': week_ending_date.isoformat() if isinstance(week_ending_date, (datetime.date, datetime.datetime)) else week_ending_date,
            'report_type': report_type,
            'date_range_start': start_date.isoformat() if isinstance(start_date, (datetime.date, datetime.datetime)) else start_date,
            'date_range_end': end_date.isoformat() if isinstance(end_date, (datetime.date, datetime.datetime)) else end_date,
